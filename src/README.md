...
> 🚀 这是必应壁纸信息收集器的开发者和技术文档，包含代码运行、配置、API和技术实现等详细信息。
...
├── Configuration/
│   ├── AppConstants.cs                 # 应用常量配置
│   └── CollectionConfig.cs             # 收集配置模型
├── Services/
...
│       ├── UserConfigurationService.cs # 用户配置服务实现
│       └── WallpaperStorageService.cs  # 存储服务实现
├── Models/
│   ├── BingWallpaperInfo.cs            # Bing API响应模型
│   ├── WallpaperInfoStorage.cs         # 存储数据模型
...
A: 在 `Services/Impl/WallpaperStorageService.cs` 中修改JSON序列化选项：
...
- [API文档](https://www.bing.com/HPImageArchive.aspx) - Bing官方API
- [.NET 9.0 文档](https://docs.microsoft.com/dotnet/) - .NET开发文档
